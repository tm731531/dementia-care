...
| [週末帶小孩去哪](./kids-weekend/) | 家有 0-6 歲小孩 + 太太 / 朋友 | 單檔 Web App | **全台 22 縣市 800+ 親子景點 + 路線規劃**。1 題 wizard(住哪)→ 預設 20 km 推薦 → 拉滑桿 5-400 km / 標籤三態 / 設目的地組多點路線 → 一鍵丟 Google Maps 多段導航。Playwright 驗證每個景點 Google Maps 唯一性 |
